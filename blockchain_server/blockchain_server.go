...
func (bcs *BlockchainServer) GetBlockchain() *block.Blockchain {
	...
	if !ok {
		...
		cache["blockchain"] = bc
		log.Printf("privat_key %v", minersWallet.PrivateKeyStr())
		log.Printf("pubpli_key %v", minersWallet.PublicKeyStr())
		log.Printf("blockchain_addres %v", minersWallet.BlockchainAddress())
	}
...
func (bcs *BlockchainServer) Transactions(w http.ResponseWriter, req *http.Request) {
	...
	case http.MethodPost:
		...
		publicKey := utils.PublicKeyFromString(*t.SenderPublicAddress)
		signature := utils.SignFromString(*t.Signature)
