...
func NewWallet() *Wallet {
	...
	// 8. Add the 4 checksum bytes from 7 at the end of the RIPEDM-160 hash from 4 (25 bytes)
	dc8 := make([]byte, 25)
	copy(dc8[:21], vd4[:])
	copy(dc8[:21], chsum[:])
...
func (tr *TransactionRequest) Validate() bool {
	if tr.SenderBlockchainAddress == nil || tr.RecipientBlockchainAddress == nil || tr.SenderPublicKey == nil || tr.Value == nil {
		return false
	}
